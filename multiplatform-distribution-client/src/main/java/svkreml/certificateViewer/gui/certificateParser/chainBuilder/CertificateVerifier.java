...
public class CertificateVerifier {
    ...
    public CertificateVerifier(Set<X509Certificate> additionalCerts) throws CertificateException, NoSuchAlgorithmException, NoSuchProviderException, InvalidAlgorithmParameterException {
        ...
        System.out.println("Init CertificateVerifier: " + (stop - start));
    }
    ...
    private PKIXCertPathBuilderResult verifyCertificateP(X509Certificate cert) throws GeneralSecurityException {
        ...
        stores.add(CertStore.getInstance("Collection", new CollectionCertStoreParameters(Collections.singletonList(cert)), "BC"));
        pkixParams.setCertStores(stores);
        return (PKIXCertPathBuilderResult) certPathBuilder.build(pkixParams);
    }

    public PKIXCertPathBuilderResult verifyCertificate(X509Certificate cert) throws CertificateVerificationException, GeneralSecurityException {
