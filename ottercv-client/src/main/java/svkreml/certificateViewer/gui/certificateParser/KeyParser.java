...
public class KeyParser {
    ...
    public static KeyInfo getKeyInfo(PublicKey publicKey) throws InvalidKeySpecException, NoSuchAlgorithmException, NoSuchProviderException {
        //        AsymmetricKeyParameter publicKey = PublicKeyFactory.createKey(publicKey);
        ...
        } else if (algorithm.equals("ECGOST3410-2012")) {
        ...
        return new KeyInfo(algorithm); // size unknown
    }
